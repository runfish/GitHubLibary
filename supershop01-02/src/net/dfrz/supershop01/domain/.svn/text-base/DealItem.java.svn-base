...
public class DealItem extends ObjectValue {
    ...
    */
    ...
    /**
     * 修改订单条目中的商品的单价
     * @param itemGoodsPrice -当前订单条目中的商品的单价
     */
    ...
    */
    ...
    /**
     * 修改订单的条目中的商品的商品编号
     * @param dealGoodsId -当前订单条目中的商品编号
     */
   ...
   /**
    * 修改订单的条目中的商品所属的小类别编号
    * @param dealGoodsCtgId -当前订单条目中的商品所属的小类别编号
    */
